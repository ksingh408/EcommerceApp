...
//     e.preventDefault();
//     if (editProductId) {
//       // Pass the correct structure to updateProduct
//       dispatch(updateProduct({ data: form, _id: editProductId }));
//       console.log("Product updated:", form); // Debugging log
//       alert("Product updated successfully!");
//     } else {
//       dispatch(createProduct(form)); // Create new product
//     }
